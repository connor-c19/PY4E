...
Actual data: http://py4e-data.dr-chuck.net/comments_2130751.html (Sum ends with 15)
You do not need to save these files 
    to your folder since your program will read the data directly from the URL
...
if len(url) < 1: 
    url = 'http://py4e-data.dr-chuck.net/comments_2130751.html'
