...
- **A note about the bullet points above:** The first and second bullet points are lines of Python code. The third line is the output generated after line 1 (`variable2 = "pie"`) and line 2 (`print(variable2)`) are ran, hence why it doesn't appear in a code block (`code blocks look like this`). The same goes for the next three bullet points: lines four and five are run, generating line six as an output.
